...
object SharedPrefs {
    private const val SHARED_PREFS_NAME = "the_movie_app_prefs"
    val sharedPreferences: SharedPreferences =
        domain.getSharedPreferences(SHARED_PREFS_NAME, Context.MODE_PRIVATE)
